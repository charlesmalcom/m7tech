        ...
        <thead>
            <tr>
                <td colspan='6'>
                    ...
                    <a href="<?php echo $this->config->item('baseURL'); ?>clients/search" class="button">Search Clients [ X ]</a>
                </td>
            </tr>
            <tr>
                ...
                <td><a href="<?php echo $this->config->item('baseURL'); ?>clients/show/businessName/city/" alt="Sort by City">
                City</a></td>

                <td><a href="<?php echo $this->config->item('baseURL'); ?>clients/show/businessName/state/" alt="Sort by State">
                State</a></td>
