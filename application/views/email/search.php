...
//echo pop3_login('mail.livewv.com', '143', 'charles.livewv', 'charles123malcom', $folder="Inbox", $ssl=false);
$connection = pop3_login('192.168.0.70', '143', 'charles.livewv', 'malcom123', $folder="Inbox", $ssl=false);


/* LIST INBOX CONTENT */
function showInboxContents(){
...
echo showInboxContents();
echo"<hr />";
echo CountUnreadMails('192.168.0.70', 'charles.livewv', 'malcom123');
